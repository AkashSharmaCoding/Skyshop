...
<!-----logo and nav over----->
	...
	<img src="img/banner.jpg" style="width:1024px; height:150px;">
...
$showsql = "select * from addmobiles where brand='HTC' " or die(mysql_error());
...
$pagesize=6;
	...
	if(ExecPaging($showsql,$parameter,$pagesize))
						...
						$rid=ExecPaging($showsql,$parameter,$pagesize,"htc.php");
