...
<!-----logo and nav over----->
	...
	<br>
	<br>
    <h2 class="nesmid1">Laptop Description</h2>
...
$sql= mysqli_query($dbb,"select * from addlaptop where id='$idd' ") or die(mysqli_error());
...
{
	$quantity= $_POST['quan'];
	header("location:cart.php?product_id=$idd&&quan=$quantity&&tablename=addlaptop");
}
?>
    <form method="post">
    <select name="quan">
...
<tr>
<td>RAM</td>
<td>:</td><td><?php echo $row['ram']; ?></td>
</tr>
<tr>
<td>Graphic</td>
<td>:</td><td><?php echo $row['graphic']; ?></td>
</tr>
<tr>
<td>Display</td>
<td>:</td><td><?php echo $row['display']; ?></td>
</tr>
<tr>
<td>Processor</td>
<td>:</td><td>i7</td>
