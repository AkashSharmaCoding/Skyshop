...
<!-----logo and nav over----->
	<div class="titleforpage">
     ...
     <img src="img/iphn bnr.jpg" style="width:1024px; height:150px;">
...
$showsql = "select * from addmobiles where brand='apple' " or die(mysqli_error());
...
$pagesize=6;
	...
	if(ExecPaging($showsql,$parameter,$pagesize))
						...
						$rid=ExecPaging($showsql,$parameter,$pagesize,"apple.php");
