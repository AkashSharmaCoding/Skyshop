...
<!-----logo and nav over----->
	...
	<img src="img/lg-phone-landing-banner.jpg" style="width:1024px; height:150px;">
...
$showsql = "select * from addmobiles where brand='lg' " or die(mysqli_error());
...
$pagesize=6;
	...
	if(ExecPaging($showsql,$parameter,$pagesize))
						...
						$rid=ExecPaging($showsql,$parameter,$pagesize,"lg.php");
