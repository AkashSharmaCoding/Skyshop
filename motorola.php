...
<!-----logo and nav over----->
	...
	<img src="img/Motorola-Banner.jpg" style="width:1024px; height:150px;">
...
$showsql = "select * from addmobiles where brand='motorola' " or die(mysqli_error());
...
$pagesize=6;
	...
	if(ExecPaging($showsql,$parameter,$pagesize))
						...
						$rid=ExecPaging($showsql,$parameter,$pagesize,"motorola.php");
...
<a href="mobiledescription.php?url= <?php echo $rid[$i]['id'] ?> ">
